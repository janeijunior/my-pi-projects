...
class Agendamento(object):
    ...
    def gravarRegistroBanco(self):
        ...
        if self.rele == None:
            ...
            sql = "insert into Agendamento (IdRele, DataHoraInicial, DataHoraFinal, EhAlarme) values ({idRele}, {dataInicial}, {dataFinal}, 0)".format(dataInicial = self.dataHoraInicial, dataFinal = self.dataHoraFinal)
